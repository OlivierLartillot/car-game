...
class Personnages 
{
    ...
    public function __construct($name = 'default', string $image_marqueur, int $vitesseMinimum, int $vitesseMaximum, int $forceMinimum, int $forceMaximum, $fatigueApresFrappeMinimum, $fatigueApresFrappeMaximum, $deApresFrappeMinimum, $deApresFrappeMaximum)
    {
        $this->name = $name;
